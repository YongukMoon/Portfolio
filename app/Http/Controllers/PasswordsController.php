...
class PasswordsController extends Controller
{
    ...
    public function postRemind(Request $request){
        ...
        flash(trans('flash.PasswordsController.postRemind'));
        return redirect('/');
    }
    ...
    public function postReset(Request $request){
        ...
        if(!$resetUser){
            flash()->error(trans('flash.PasswordsController.postReset_fail'));
            return redirect('/');
        }
        ...
        flash(trans('flash.PasswordsController.postReset'));
        return redirect('/');
    }
}
