...
return [
    ...
    */
    ...
    'min'                  => [
        'numeric' => ':attribute은(는) :min 이상 이여야합니다.',
        'file'    => ':attribute은(는) :min KB 보다 커야합니다.',
        'string'  => ':attribute은(는) :min 글자 이상 이여야합니다.',
        'array'   => ':attribute은(는) :min 개 이상 이여야합니다.',
    ],
    'not_in'               => '선택된 :attribute은(는) 유효하지 않습니다.',
    'numeric'              => ':attribute은(는) 숫자 여야합니다.',
    'present'              => ':attribute 가 있어야 합니다.',
    'regex'                => ':attribute은(는) 유효하지 않습니다.',
    'required'             => ':attribute은(는) 필수 입력 항목 입니다.',
